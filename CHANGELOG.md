...
* Switch Babel preset on eject ([#328](https://github.com/powermobileteam/create-react-native-app/pull/328))
* Fix yarnpkg alias usage in the init script ([#329](https://github.com/powermobileteam/create-react-native-app/pull/329))

#### Features

* Add interactive mode with keyboard commands ([#326](https://github.com/powermobileteam/create-react-native-app/pull/326))
* Include whether dev or production is enabled in "Running app on" message ([655960](https://github.com/powermobileteam/create-react-native-app/commit/655960090393673ec0a6208a1afac8f6821664e5))
...
* Fix broken link in README to test example. ([532258](https://github.com/powermobileteam/create-react-native-app/commit/5322584644413c1ea4ac70bbf1629a71803b27d5))
* Fix npm 5 version validation. ([#317](https://github.com/powermobileteam/create-react-native-app/pull/317))

#### Features

* Add `--package-manager` option which allows you to specify any package manager to use when creating a project. ([#307](https://github.com/powermobileteam/create-react-native-app/pull/307))
...
* Add CHANGELOG.md ([#319](https://github.com/powermobileteam/create-react-native-app/pull/319))
